...
#ifndef __OMP_TOOLS__
#define __OMP_TOOLS__
...
#define FOREACH_OMPT_EVENT(macro)                                                                                        \
    ...
    /* 5.1 Events */                                                                                                     \
                                                                                                                         \
    /* Target callbacks with external monitoring interface (emi) */                                                      \
    macro (ompt_callback_target_emi,         ompt_callback_target_emi_t,         33) /* target                        */ \
    macro (ompt_callback_target_data_op_emi, ompt_callback_target_data_op_emi_t, 34) /* target data                   */ \
