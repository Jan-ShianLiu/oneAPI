...
/* <copyright>
    ...
    Copyright 1985-2020 Intel Corporation.
...
#   define KMP_VERSION_BUILD    20201007
#   define KMP_BUILD_DATE       "2020-10-12 18:45:32 UTC"
...
#   include <stdint.h>
    ...
    extern int          __KAI_KMPC_CONVENTION  omp_get_num_interop_properties(omp_interop_t);
    ...
    extern const char * __KAI_KMPC_CONVENTION  omp_get_interop_name(omp_interop_t, omp_interop_property_t);
    extern const char * __KAI_KMPC_CONVENTION  omp_get_interop_type_desc(omp_interop_t, omp_interop_property_t);
    extern const char * __KAI_KMPC_CONVENTION  omp_get_interop_err(omp_interop_rc_t);
