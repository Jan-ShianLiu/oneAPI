...
#ifndef SDLT_SOA_STRIDE_OFFSET_CALCULATOR_H
#define SDLT_SOA_STRIDE_OFFSET_CALCULATOR_H
...
template<typename BuiltInT, typename IntSequenceT, typename IndicesT, typename OriginT, typename StridesT>
struct stride_offset_calculator; /* undefined */

template<typename BuiltInT, typename IndicesT, typename OriginT, typename StridesT>
...
template<typename BuiltInT, typename IndexT, typename OriginOffsetT, typename StrideT>
SDLT_INLINE
...
template<typename BuiltInT, int HeadIndexT, typename IndicesT, typename OriginT, typename StridesT>
struct stride_offset_calculator<BuiltInT, int_sequence<HeadIndexT>, IndicesT, OriginT, StridesT>
{
    static SDLT_INLINE
        ...
        ->decltype(compute_stride<BuiltInT>(a_indices.template get<HeadIndexT>(), a_origin.template get<HeadIndexT>(), a_strides.template get<HeadIndexT + 1>()))
    {
        ...
        return compute_stride<BuiltInT>(index, origin_offset, stride);
    }
};

template<typename BuiltInT, int HeadIndexT, int... TailOfIndicesT, typename IndicesT, typename OriginT, typename StridesT>
struct stride_offset_calculator<BuiltInT, int_sequence<HeadIndexT, TailOfIndicesT...>, IndicesT, OriginT, StridesT>
{
    static SDLT_INLINE auto compute(const IndicesT &a_indices, const OriginT &a_origin, const StridesT &a_strides)
        ->decltype(compute_stride<BuiltInT>(a_indices.template get<HeadIndexT>(), a_origin.template get<HeadIndexT>(), a_strides.template get<HeadIndexT + 1>()) +
            stride_offset_calculator<BuiltInT, int_sequence<TailOfIndicesT...>, IndicesT, OriginT, StridesT>::compute(a_indices, a_origin, a_strides))
    {
        auto index = a_indices.template get<HeadIndexT>();
        auto origin_offset = a_origin.template get<HeadIndexT>();
        auto stride = a_strides.template get<HeadIndexT+1>();
...
template<typename BuiltInT, class... IndexTypeListT, typename OriginT, typename StridesT>
static std::size_t
calculate_stride_offset(const index_list<IndexTypeListT...> &a_indices, const OriginT &a_origin, const StridesT &a_strides)
{
    return stride_offset_calculator<BuiltInT, make_int_sequence<sizeof...(IndexTypeListT)-1>, index_list<IndexTypeListT...>, OriginT, StridesT>::compute(a_indices, a_origin, a_strides);
}
#else
...
template<typename BuiltInT, class... IndexTypeListT, typename OriginT, typename StridesT>
struct pre_stride_offset_calculator<BuiltInT, index_list<IndexTypeListT...>, OriginT, StridesT>
{
    ...
    static SDLT_INLINE auto
        ...
        ->decltype(stride_offset_calculator<BuiltInT, int_seq_type, indices_type, OriginT, StridesT>::compute(a_indices, a_origin, a_strides))
    {
        return stride_offset_calculator<BuiltInT, int_seq_type, indices_type, OriginT, StridesT>::compute(a_indices, a_origin, a_strides);
    }
};
...
static SDLT_INLINE auto
calculate_stride_offset(const index_list<IndexTypeListT...> &a_indices, const OriginT &a_origin, const StridesT &a_strides)
->decltype(pre_stride_offset_calculator<BuiltInT, index_list<IndexTypeListT...>, OriginT, StridesT>::compute(a_indices, a_origin, a_strides))
{
    return pre_stride_offset_calculator<BuiltInT, index_list<IndexTypeListT...>, OriginT, StridesT>::compute(a_indices, a_origin, a_strides);
}
#endif
