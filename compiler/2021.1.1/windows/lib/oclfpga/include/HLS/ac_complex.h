...
public:
  ...
  template <typename T2, typename T3> constexpr ac_complex(const T2 &r, const T3 &i) {
    _r = r;
    _i = i;
  }
  ...
  template <typename T2> constexpr ac_complex &operator+=(const ac_complex<T2> &op2) {
    _r += op2.r();
    _i += op2.i();
    return *this;
  }
  ...
  typename rt_unary::mag_sqr constexpr mag_sqr() const { return _r * _r + _i * _i; }
