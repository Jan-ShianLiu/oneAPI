...
#define _MSVC_EXPORT __declspec(dllimport)
#else 
#define _MSVC_EXPORT
#endif
#endif
...
class _MSVC_EXPORT hls_vpfp_intermediate_ty {
public:
...
extern "C" _MSVC_EXPORT int hls_inter_get_str(char* allocated_buffer, size_t buffer_size,
                                      const hls_vpfp_intermediate_ty &input,
                                      int base, int rounding);

/////////////////////// Basic Arithmetic Operations ////////////////////////////

extern "C" _MSVC_EXPORT void hls_inter_add(hls_vpfp_intermediate_ty &result,
                              const hls_vpfp_intermediate_ty &input_A,
                              const hls_vpfp_intermediate_ty &input_B,
                              const bool subnormal);

extern "C" _MSVC_EXPORT void hls_inter_sub(hls_vpfp_intermediate_ty &result,
                              const hls_vpfp_intermediate_ty &input_A,
                              const hls_vpfp_intermediate_ty &input_B,
                              const bool subnormal);

extern "C" _MSVC_EXPORT void hls_inter_div(hls_vpfp_intermediate_ty &result,
                              const hls_vpfp_intermediate_ty &input_A,
                              const hls_vpfp_intermediate_ty &input_B,
                              const bool subnormal);

extern "C" _MSVC_EXPORT void hls_inter_mul(hls_vpfp_intermediate_ty &result,
                              const hls_vpfp_intermediate_ty &input_A,
                              const hls_vpfp_intermediate_ty &input_B,
                              const bool subnormal);

////////////////////////// Comparison Operations ///////////////////////////////
extern "C" _MSVC_EXPORT bool hls_inter_gt(const hls_vpfp_intermediate_ty &input_A,
                             const hls_vpfp_intermediate_ty &input_B,
                             const bool subnormal);

extern "C" _MSVC_EXPORT bool hls_inter_ge(const hls_vpfp_intermediate_ty &input_A,
                             const hls_vpfp_intermediate_ty &input_B,
                             const bool subnormal);

extern "C" _MSVC_EXPORT bool hls_inter_lt(const hls_vpfp_intermediate_ty &input_A,
                             const hls_vpfp_intermediate_ty &input_B,
                             const bool subnormal);

extern "C" _MSVC_EXPORT bool hls_inter_le(const hls_vpfp_intermediate_ty &input_A,
                             const hls_vpfp_intermediate_ty &input_B,
                             const bool subnormal);

extern "C" _MSVC_EXPORT bool hls_inter_eq(const hls_vpfp_intermediate_ty &input_A,
                             const hls_vpfp_intermediate_ty &input_B,
                             const bool subnormal);

/////////////////////// Commonly Used Math Operations //////////////////////////
/// computes the square root of x -> x^(1/2)
extern "C" _MSVC_EXPORT void hls_inter_sqrt(hls_vpfp_intermediate_ty &result,
                               const hls_vpfp_intermediate_ty &input,
                               const bool subnormal = false);

/// computes the cube root of x -> x^(1/3)
extern "C" _MSVC_EXPORT void hls_inter_cbrt(hls_vpfp_intermediate_ty &result,
                               const hls_vpfp_intermediate_ty &input,
                               const bool subnormal = false);

/// computes the reciprocal of x -> 1/x
extern "C" _MSVC_EXPORT void hls_inter_recip(hls_vpfp_intermediate_ty &result,
                                const hls_vpfp_intermediate_ty &input,
                                const bool subnormal = false);

/// computes the reciprocal sqrt of x -> 1/sqrt(x)
extern "C" _MSVC_EXPORT void hls_inter_rsqrt(hls_vpfp_intermediate_ty &result,
                                const hls_vpfp_intermediate_ty &input,
                                const bool subnormal = false);

/// computes the hypotenuse of x and y -> srqt(x^2 + y^2)
extern "C" _MSVC_EXPORT void hls_inter_hypot(hls_vpfp_intermediate_ty &result,
                                const hls_vpfp_intermediate_ty &input_A,
                                const hls_vpfp_intermediate_ty &input_B,
                                const bool subnormal = false);
...
extern "C" _MSVC_EXPORT void hls_inter_exp(hls_vpfp_intermediate_ty &result,
                              const hls_vpfp_intermediate_ty &input_A,
                              const bool subnormal = false);

/// computes 2 to the power of x -> 2^x
extern "C" _MSVC_EXPORT void hls_inter_exp2(hls_vpfp_intermediate_ty &result,
                               const hls_vpfp_intermediate_ty &input_A,
                               const bool subnormal = false);

/// computes 10 to the power of x -> 10^x
extern "C" _MSVC_EXPORT void hls_inter_exp10(hls_vpfp_intermediate_ty &result,
                                const hls_vpfp_intermediate_ty &input_A,
                                const bool subnormal = false);

/// computes (e to the power of x) -1 -> e^x -1
extern "C" _MSVC_EXPORT void hls_inter_expm1(hls_vpfp_intermediate_ty &result,
                                const hls_vpfp_intermediate_ty &input_A,
                                const bool subnormal = false);

/// computes the natural log of x -> ln(x)
extern "C" _MSVC_EXPORT void hls_inter_log(hls_vpfp_intermediate_ty &result,
                              const hls_vpfp_intermediate_ty &input_A,
                              const bool subnormal = false);

/// computes the base 2 log of x -> log2(x)
extern "C" _MSVC_EXPORT void hls_inter_log2(hls_vpfp_intermediate_ty &result,
                               const hls_vpfp_intermediate_ty &input_A,
                               const bool subnormal = false);

/// computes the base 10 log of x -> log10(x)
extern "C" _MSVC_EXPORT void hls_inter_log10(hls_vpfp_intermediate_ty &result,
                                const hls_vpfp_intermediate_ty &input_A,
                                const bool subnormal = false);

/// computes the natural log of (1+x) -> ln(1+x)
extern "C" _MSVC_EXPORT void hls_inter_log1p(hls_vpfp_intermediate_ty &result,
                                const hls_vpfp_intermediate_ty &input_A,
                                const bool subnormal = false);

///////////////////////// Power Functions ///////////////////////////////////
extern "C" _MSVC_EXPORT void hls_inter_pow(hls_vpfp_intermediate_ty &result,
                              const hls_vpfp_intermediate_ty &input_A,
                              const hls_vpfp_intermediate_ty &input_B,
                              const bool subnormal = false);

extern "C" _MSVC_EXPORT void hls_inter_pown(hls_vpfp_intermediate_ty &result,
                              const hls_vpfp_intermediate_ty &input_A,
                              const long int input_B,
                              const bool subnormal = false);

/////////////////////// Trigonometric Functions /////////////////////////////
extern "C" _MSVC_EXPORT void hls_inter_sin(hls_vpfp_intermediate_ty &result,
                              const hls_vpfp_intermediate_ty &input_A,
                              const bool subnormal = false);

extern "C" _MSVC_EXPORT void hls_inter_sinpi(hls_vpfp_intermediate_ty &result,
                              const hls_vpfp_intermediate_ty &input_A,
                              const bool subnormal = false);

extern "C" _MSVC_EXPORT void hls_inter_cos(hls_vpfp_intermediate_ty &result,
                              const hls_vpfp_intermediate_ty &input_A,
                              const bool subnormal = false);

extern "C" _MSVC_EXPORT void hls_inter_cospi(hls_vpfp_intermediate_ty &result,
                              const hls_vpfp_intermediate_ty &input_A,
                              const bool subnormal = false);

extern "C" _MSVC_EXPORT void hls_inter_asin(hls_vpfp_intermediate_ty &result,
                               const hls_vpfp_intermediate_ty &input_A,
                               const bool subnormal = false);

extern "C" _MSVC_EXPORT void hls_inter_asinpi(hls_vpfp_intermediate_ty &result,
                                 const hls_vpfp_intermediate_ty &input_A,
                                 const bool subnormal = false);

extern "C" _MSVC_EXPORT void hls_inter_acos(hls_vpfp_intermediate_ty &result,
                               const hls_vpfp_intermediate_ty &input_A,
                               const bool subnormal = false);

extern "C" _MSVC_EXPORT void hls_inter_acospi(hls_vpfp_intermediate_ty &result,
                                 const hls_vpfp_intermediate_ty &input_A,
                                 const bool subnormal = false);

extern "C" _MSVC_EXPORT void hls_inter_atan(hls_vpfp_intermediate_ty &result,
                               const hls_vpfp_intermediate_ty &input_A,
                               const bool subnormal = false);

extern "C" _MSVC_EXPORT void hls_inter_atanpi(hls_vpfp_intermediate_ty &result,
                                 const hls_vpfp_intermediate_ty &input_A,
                                 const bool subnormal = false);

extern "C" _MSVC_EXPORT void hls_inter_atan2(hls_vpfp_intermediate_ty &result,
                                const hls_vpfp_intermediate_ty &input_A,
                                const hls_vpfp_intermediate_ty &input_B,
                                const bool subnormal = false);

/////////////////////// Conversion Functions ////////////////////////////////
extern "C" _MSVC_EXPORT void hls_inter_convert(hls_vpfp_intermediate_ty &result,
                                  const hls_vpfp_intermediate_ty &input,
                                  const int rounding = 0,
                                  const bool subnormal = true);

extern void _MSVC_EXPORT hls_convert_int_to_hls_inter(hls_vpfp_intermediate_ty &result,
                                         const long long int &input);

extern void _MSVC_EXPORT hls_convert_int_to_hls_inter(hls_vpfp_intermediate_ty &result,
                                         const unsigned long long int &input);

extern void _MSVC_EXPORT hls_convert_hls_inter_to_int(long long int &result,
                                         const hls_vpfp_intermediate_ty &input,
                                         bool emit_warnings = false);

extern void _MSVC_EXPORT hls_convert_hls_inter_to_int(unsigned long long int &result,
                                         const hls_vpfp_intermediate_ty &input,
                                         bool emit_warnings = false);
