...
module acl_embedded_workgroup_issuer_dspba (
 ...
 output logic [31:0] linear_local_id_out;

 // Hardware work-group id. In range of [0, MAX_SIMULTANEOUS_WORKGROUPS - 1].
 output logic [31:0] hw_wg_id_out;

 // The hardware work-group id of the work-group that is exiting.
 input wire [31:0] done_hw_wg_id_in;

 // Pass though global_id, local_id and group_id.
 input wire [GLOBAL_ID_WIDTH-1:0] global_id_in_0;
 input wire [GLOBAL_ID_WIDTH-1:0] global_id_in_1;
 input wire [GLOBAL_ID_WIDTH-1:0] global_id_in_2;
 input wire [31:0] local_id_in_0;
 input wire [31:0] local_id_in_1;
 input wire [31:0] local_id_in_2;
 input wire [31:0] group_id_in_0;
 input wire [31:0] group_id_in_1;
 input wire [31:0] group_id_in_2;
 output logic [GLOBAL_ID_WIDTH-1:0] global_id_out_0;
 output logic [GLOBAL_ID_WIDTH-1:0] global_id_out_1;
 output logic [GLOBAL_ID_WIDTH-1:0] global_id_out_2;
 output logic [31:0] local_id_out_0;
 output logic [31:0] local_id_out_1;
 output logic [31:0] local_id_out_2;
 output logic [31:0] group_id_out_0;
 output logic [31:0] group_id_out_1;
 output logic [31:0] group_id_out_2;

 logic [GLOBAL_ID_WIDTH-1:0] temp_global_id_in[2:0];
 logic [31:0] temp_local_id_in[2:0];
 logic [31:0] temp_group_id_in[2:0];
 logic [GLOBAL_ID_WIDTH-1:0] temp_global_id_out[2:0];
 ...
 acl_embedded_workgroup_issuer issuer_core(
   ...
   defparam issuer_core.ASYNC_RESET = ASYNC_RESET;
   defparam issuer_core.SYNCHRONIZE_RESET = SYNCHRONIZE_RESET;
   defparam issuer_core.GLOBAL_ID_WIDTH = GLOBAL_ID_WIDTH;
