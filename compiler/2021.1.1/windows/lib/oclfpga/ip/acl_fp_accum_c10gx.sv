...
module acl_fp_accum_c10gx(dataa, datab, pop_feedback_n, clear_accumulator, keep_going, predicate, clock, result, valid_in, valid_out, stall_in, stall_out, resetn, ecc_err_status);
