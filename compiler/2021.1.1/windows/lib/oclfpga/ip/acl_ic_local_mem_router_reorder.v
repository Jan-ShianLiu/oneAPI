...
(
    ...
    begin:rrp
        ...
        begin:bank
            ...
            wire [1:0] df_update; 
            wire [$clog2(READ_DATA_FIFO_DEPTH):0] df_update_extended; 
            ...
            assign df_update = incr_df_free - decr_df_free;
            assign df_update_extended = $signed(df_update);
            ...
            always @( posedge clock or negedge resetn )
                if( !resetn )
                    ...
                    df_free <= df_free + df_update_extended;
    ...
    begin:wrp
        ...
        wire [1:0] ack_free_update;
        wire [$clog2(WRITE_ACK_FIFO_DEPTH):0] ack_free_update_extended;
        ...
        always @( posedge clock or negedge resetn )
            if( !resetn )
                ...
                ack_free <= ack_free + ack_free_extended;

        assign incr_ack_free = decr_ack_counter;
        assign decr_ack_free = m_arb_write & ~(req.stall | ack_no_free);
        assign ack_free_update = incr_ack_free - decr_ack_free;
        assign ack_free_extended = $signed(ack_free_update);
