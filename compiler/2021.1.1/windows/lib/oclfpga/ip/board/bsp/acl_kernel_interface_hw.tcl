...
add_parameter KERNEL_RESET_GLOBAL INTEGER 1
set_parameter_property KERNEL_RESET_GLOBAL DEFAULT_VALUE 1
set_parameter_property KERNEL_RESET_GLOBAL DISPLAY_NAME "Make kernel reset a global signal"
set_parameter_property KERNEL_RESET_GLOBAL AFFECTS_ELABORATION true
# | 
# +-----------------------------------
...
proc compose { } {
    ...
    set kernel_reset_global [get_parameter_value KERNEL_RESET_GLOBAL]
    ...
    add_instance address_span_extender_0 altera_address_span_extender 15.0
