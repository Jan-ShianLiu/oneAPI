...
# module properties
set_module_property NAME {kernel_interface_s10}
set_module_property DISPLAY_NAME {OpenCL Kernel Interface for S10}
...
proc compose { } {
    ...
    set_instance_parameter_value clock_crosser {DATA_W} {64}
    set_instance_parameter_value clock_crosser {ADDRESS_W} {30}
    ...
    set_instance_parameter_value clock_crosser {SLAVE_PORT_WAITREQUEST_ALLOWANCE} {0}
    set_instance_parameter_value clock_crosser {MASTER_PORT_WAITREQUEST_ALLOWANCE} {1}
