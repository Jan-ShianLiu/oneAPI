...
altpcie_hip_256_pipen1b # (
      ...
      .npor                                                           (npor                                                                ),//input
      .cvp_tx_analogreset                                             (cvp_tx_analogreset                                                  ),//input
...
//////////////// END SYNTHESIS-ONLY CONTENTS
   ...
   wire cvp_tx_analogreset;
   cvp_update_reset # (
      .PIPE32_SIM_ONLY(PIPE32_SIM_ONLY)
   ) cvp_update_reset_inst (
            .pipe8_sim_only               (((ALTPCIE_SV_HIP_AST_HWTCL_SIM_ONLY==0)||(enable_pipe32_sim_hwtcl==1))?
                                           1'b0:simu_mode_pipe),//input
            .npor              (npor),
            .perst             (pin_perst),
            .cvp_tx_analogreset(cvp_tx_analogreset)
   );
