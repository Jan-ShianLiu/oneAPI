...
add_parameter SLAVE_PORT_WAITREQUEST_ALLOWANCE INTEGER 0 "Slave port waitrequest allowance"
set_parameter_property SLAVE_PORT_WAITREQUEST_ALLOWANCE DEFAULT_VALUE 0
set_parameter_property SLAVE_PORT_WAITREQUEST_ALLOWANCE DISPLAY_NAME SLAVE_PORT_WAITREQUEST_ALLOWANCE
...
set_parameter_property SLAVE_PORT_WAITREQUEST_ALLOWANCE ALLOWED_RANGES 0:7
set_parameter_property SLAVE_PORT_WAITREQUEST_ALLOWANCE DESCRIPTION "Slave port waitrequest allowance"
...
add_interface_port cra_slave avs_addr address Input ADDR_W+ID_W+ROM_EXT_W+ROM_ENABLE
