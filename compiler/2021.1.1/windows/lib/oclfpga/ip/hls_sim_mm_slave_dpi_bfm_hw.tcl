...
set_module_property NAME                         hls_sim_mm_slave_dpi_bfm
set_module_property GROUP                        "HLS Simulation"
set_module_property DISPLAY_NAME                 "HLS Simulation Avalon-MM Slave DPI BFM"
set_module_property DESCRIPTION                  "HLS Simulation Avalon-MM Slave DPI BFM"
...
set_fileset_property sim_verilog top_level hls_sim_mm_slave_dpi_bfm

add_fileset quartus_synth QUARTUS_SYNTH quartus_synth_proc
set_fileset_property quartus_synth top_level hls_sim_mm_slave_dpi_bfm
...
proc sim_verilog {hls_sim_mm_slave_dpi_bfm} {
   ...
   add_fileset_file hls_sim_mm_slave_dpi_bfm.sv SYSTEM_VERILOG PATH hls_sim_mm_slave_dpi_bfm.sv
...
proc quartus_synth_proc {hls_sim_mm_slave_dpi_bfm} {
   set QSYS_VERIFICATION_IP [get_qsys_verification_ip_path]
