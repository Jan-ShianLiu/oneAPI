...
/*
 *
 * fftwf_plan_guru64_r2r - FFTW3 wrapper to Intel(R) Math Kernel Library (Intel(R) MKL).
 *
 ******************************************************************************
 */
...
static const char FFTW3_MKL_1[] =
    ...
    "planning r2r transforms with FFTW3 interface to Intel MKL "
    "(see Intel MKL Reference Manual).";
static const char FFTW3_MKL_2_I[] =
    "Error: Intel MKL TT initialization failed with status=%d "
    "in FFTW3 interface to Intel MKL.";
static const char FFTW3_MKL_3_I[] =
    "Error: Intel MKL TT commit step failed with status=%d "
    "in FFTW3 interface to Intel MKL.";
static const char FFTW3_MKL_4_I[] =
    "Error: Intel MKL TT backward transform failed with status=%d "
    "in FFTW3 interface to Intel MKL.";
static const char FFTW3_MKL_5_I[] =
    "Error: Intel MKL TT forward transform failed with status=%d "
